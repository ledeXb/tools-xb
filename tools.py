...
def main():
	...
	time.sleep(0.10)
	print "   {10} Exit the tools-xb\n"
	tools = raw_input("tools-xb > ")
	...
	if tools == "1" or tools == "01":
		...
		infogathering = raw_input("tools-xb > ")
